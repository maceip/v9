...
function _notImplemented(name) {
  return class { constructor(...a) { /* module stub */ } };
}

export const Module = typeof _impl.Module !== 'undefined' ? _impl.Module : _notImplemented('module.Module');
export const SourceMap = typeof _impl.SourceMap !== 'undefined' ? _impl.SourceMap : _notImplemented('module.SourceMap');
export const builtinModules = typeof _impl.builtinModules !== 'undefined' ? _impl.builtinModules : _notImplemented('module.builtinModules');
export const constants = typeof _impl.constants !== 'undefined' ? _impl.constants : _notImplemented('module.constants');
export const createRequire = typeof _impl.createRequire !== 'undefined' ? _impl.createRequire : _notImplemented('module.createRequire');
...
export const isBuiltin = typeof _impl.isBuiltin !== 'undefined' ? _impl.isBuiltin : _notImplemented('module.isBuiltin');
